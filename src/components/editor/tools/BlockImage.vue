<template>
    <div v-if="editor.current && canHaveImage" class="flex flex-col p-2 text-xs col-span-2">
        Image URL
        <textarea v-model="editor.current.image.url" class="my-2 font-mono text-xs h-16"/>
        <div class="h-40">
